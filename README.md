...
Everything else (menu copy, prices, category order, layout, colors, hours, address, and phone) is kept as on the original. The footer credit is **ساخته شده توسط گروه طراحی ویژن** in Estedad.
...
- Persian text uses **Estedad** (self-hosted variable font).
